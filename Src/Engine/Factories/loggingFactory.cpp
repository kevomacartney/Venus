...
Venus::Factories::Logging::LoggingFactory::CreateLogger(std::shared_ptr<spdlog::logger> (*f)()) {
    std::shared_ptr<spdlog::logger> logger = f();
    return logger;
}

std::shared_ptr<spdlog::logger>
Venus::Factories::Logging::LoggingFactory::CreateLogger(Venus::Factories::Logging::LoggerType type,
